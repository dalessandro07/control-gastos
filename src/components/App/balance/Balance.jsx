          ...
          gastos.length > 0 ? (
            selectedTag?.tag ? (
              ...
              <section className="my-6 mx-3 flex flex-col">
                ...
                <p className="mx-10 mt-5 text-center text-xs text-gray-600 sm:text-sm">
                  Puede presionar alguna sección del gráfico para ver una lista detallada de los
                  gastos.
                </p>
